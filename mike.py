...
KAC=[cl,ki,kk,kc,kd,ke,kf,kg,kh,kj,kl,km,kn,ko,kp,kq,kr,ks,kt,ku,kv,kw,kx,ky,kz]
...
Umid = ku.getProfile().mid
Vmid = kv.getProfile().mid
Wmid = kw.getProfile().mid
Xmid = kx.getProfile().mid
Ymid = ky.getProfile().mid
Zmid = kz.getProfile().mid
protectname = []
protecturl = []
protection = []
autocancel = {}
...
autoleaveroom = []
targets = []
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid,Vmid,Wmid,Xmid,Ymid,Zmid]
...
owner = ["ua87810961d8822889217ef0eb64262cf",mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Jmid,Lmid,Mmid,Nmid,Omid,Pmid,Qmid,Rmid,Smid,Tmid,Umid,Vmid,Wmid,Xmid,Ymid,Zmid]
wait = {
    'contact':False,
    'autoJoin':False,
...
contact = kv.getProfile()
backup = kv.getProfile()
backup.displayname = contact.displayName
backup.statusMessage = contact.statusMessage
backup.pictureStatus = contact.pictureStatus

contact = kw.getProfile()
backup = kw.getProfile()
backup.displayname = contact.displayName
backup.statusMessage = contact.statusMessage
backup.pictureStatus = contact.pictureStatus

contact = kx.getProfile()
backup = kx.getProfile()
backup.displayname = contact.displayName
backup.statusMessage = contact.statusMessage
backup.pictureStatus = contact.pictureStatus

contact = ky.getProfile()
backup = ky.getProfile()
backup.displayname = contact.displayName
backup.statusMessage = contact.statusMessage
backup.pictureStatus = contact.pictureStatus

contact = kz.getProfile()
backup = kz.getProfile()
backup.displayname = contact.displayName
backup.statusMessage = contact.statusMessage
backup.pictureStatus = contact.pictureStatus
